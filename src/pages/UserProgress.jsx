    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl sm:text-3xl font-bold text-gray-900">{t('pages.userProgress.title')}</h1>
                <p className="text-sm sm:text-base text-gray-600 mt-0.5 sm:mt-1">{t('pages.userProgress.subtitle')}</p>
              </div>
            </div>
        ...
        {goalInfo && (
          <div className="mb-8 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="rounded-2xl bg-gradient-to-br from-white/60 to-white/30 backdrop-blur-xl border border-white/20 p-5">
              <p className="text-xs font-semibold text-gray-600 uppercase tracking-wider">{t('pages.userProgress.goal')}</p>
            ...
            <div className="rounded-2xl bg-gradient-to-br from-purple-50/50 to-purple-100/30 backdrop-blur-xl border border-white/20 p-5">
              <p className="text-xs font-semibold text-purple-600 uppercase tracking-wider">{t('pages.userProgress.targetWeight')}</p>
            ...
            <div className="rounded-2xl bg-gradient-to-br from-green-50/50 to-green-100/30 backdrop-blur-xl border border-white/20 p-5">
              <p className="text-xs font-semibold text-green-600 uppercase tracking-wider">{t('pages.userProgress.remaining')}</p>
        ...
        {loading ? (
          ...
          <div className="mb-8">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">{t('pages.userProgress.measurementsOverview')}</h2>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      <h3 className="text-base font-semibold text-gray-900">{t('pages.userProgress.weight')}</h3>
                      <p className="text-sm text-gray-600 mt-0.5">{t('pages.userProgress.latest')}: {getLatestMeasurement('currentWeightInKg')?.toFixed(1) || '-'} {t('pages.userProgress.kg')}</p>
                    </div>
                  </div>
                ...
                <div className="rounded-3xl bg-gradient-to-br from-orange-50/60 to-orange-100/30 backdrop-blur-xl border border-orange-200/20 shadow-xl overflow-hidden">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        <h3 className="text-base font-semibold text-gray-900">{t('pages.userProgress.bodyFat')}</h3>
                        <p className="text-sm text-gray-600 mt-0.5">{t('pages.userProgress.latest')}: {getLatestMeasurement('currentFatPercentage')?.toFixed(1) || '-'} %</p>
                      </div>
                    </div>
                ...
                <div className="rounded-3xl bg-gradient-to-br from-blue-50/60 to-blue-100/30 backdrop-blur-xl border border-blue-200/20 shadow-xl overflow-hidden">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        <h3 className="text-base font-semibold text-gray-900">{t('pages.userProgress.water')}</h3>
                        <p className="text-sm text-gray-600 mt-0.5">{t('pages.userProgress.latest')}: {getLatestMeasurement('currentWaterPercentage')?.toFixed(1) || '-'} %</p>
                      </div>
                    </div>
                ...
                <div className="rounded-3xl bg-gradient-to-br from-emerald-50/60 to-emerald-100/30 backdrop-blur-xl border border-emerald-200/20 shadow-xl overflow-hidden">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        <h3 className="text-base font-semibold text-gray-900">{t('pages.userProgress.waist')}</h3>
                        <p className="text-sm text-gray-600 mt-0.5">{t('pages.userProgress.latest')}: {getLatestMeasurement('currentWaistSizeInCm')?.toFixed(1) || '-'} {t('pages.userProgress.cm')}</p>
                      </div>
                    </div>
                ...
                <div className="rounded-3xl bg-gradient-to-br from-cyan-50/60 to-cyan-100/30 backdrop-blur-xl border border-cyan-200/20 shadow-xl overflow-hidden">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        <h3 className="text-base font-semibold text-gray-900">{t('pages.userProgress.chest')}</h3>
                        <p className="text-sm text-gray-600 mt-0.5">{t('pages.userProgress.latest')}: {getLatestMeasurement('currentChestSizeInCm')?.toFixed(1) || '-'} {t('pages.userProgress.cm')}</p>
                      </div>
                    </div>
                ...
                <div className="rounded-3xl bg-gradient-to-br from-pink-50/60 to-pink-100/30 backdrop-blur-xl border border-pink-200/20 shadow-xl overflow-hidden">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        <h3 className="text-base font-semibold text-gray-900">{t('pages.userProgress.hips')}</h3>
                        <p className="text-sm text-gray-600 mt-0.5">{t('pages.userProgress.latest')}: {getLatestMeasurement('currentHipSizeInCm')?.toFixed(1) || '-'} {t('pages.userProgress.cm')}</p>
                      </div>
                    </div>
                ...
                <div className="rounded-3xl bg-gradient-to-br from-amber-50/60 to-amber-100/30 backdrop-blur-xl border border-amber-200/20 shadow-xl overflow-hidden">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        <h3 className="text-base font-semibold text-gray-900">{t('pages.userProgress.thigh')}</h3>
                        <p className="text-sm text-gray-600 mt-0.5">{t('pages.userProgress.latest')}: {getLatestMeasurement('currentThighSizeInCm')?.toFixed(1) || '-'} {t('pages.userProgress.cm')}</p>
                      </div>
                    </div>
          ...
          <div className="flex items-center justify-center h-80 bg-white/50 backdrop-blur-md rounded-3xl border border-white/20">
            <div className="text-center">
              ...
              <p className="text-gray-600">{t('pages.userProgress.noProgressData')}</p>
              <p className="text-sm text-gray-500 mt-1">{t('pages.userProgress.startTracking')}</p>
            </div>
          </div>
        )}
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200">
                    ...
                    >
                      <div className="flex items-center gap-1">
                        {t('pages.userProgress.weightKg')}
                        {sortBy === 'weight' && (
                          sortOrder === 'asc' ? <ChevronUpIcon className="w-4 h-4" /> : <ChevronDownIcon className="w-4 h-4" />
                        )}
                      </div>
                    </th>
                    <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase">{t('pages.userProgress.fatPercent')}</th>
                    <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase">{t('pages.userProgress.waistCm')}</th>
                    <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase">{t('pages.userProgress.chestCm')}</th>
                    <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase">{t('pages.userProgress.actions')}</th>
                  </tr>
                </thead>
                <tbody>
